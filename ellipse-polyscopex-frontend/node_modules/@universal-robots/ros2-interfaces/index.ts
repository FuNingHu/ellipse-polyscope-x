...
export interface IRosTypeGeometryMsgsPolygonInstance {
  polygon: IRosTypeGeometryMsgsPolygon;
  id: number;
}

export interface IRosTypeGeometryMsgsPolygonInstanceStamped {
  header: IRosTypeStdMsgsHeader;
  polygon: IRosTypeGeometryMsgsPolygonInstance;
}
...
export interface IRosTypeUrinterfacesActiveTcp {
  header: IRosTypeStdMsgsHeader;
  data: string;
}

export interface IRosTypeUrinterfacesAnalog {
  pin: number;
  domain: number;
  value: number;
}

export enum IRosTypeUrinterfacesAnalogConst {
  CURRENT = 0,
  VOLTAGE = 1,
}

export interface IRosTypeUrinterfacesAnalogIo {
  analog_inputs: IRosTypeUrinterfacesAnalog[];
  analog_outputs: IRosTypeUrinterfacesAnalog[];
}

export interface IRosTypeUrinterfacesAnalogIoStateStamped {
  header: IRosTypeStdMsgsHeader;
  io_state: IRosTypeUrinterfacesAnalogIo;
}

export interface IRosTypeUrinterfacesAnalogStamped {
  header: IRosTypeStdMsgsHeader;
  data: IRosTypeUrinterfacesAnalog;
}

export interface IRosTypeUrinterfacesBoolStamped {
  header: IRosTypeStdMsgsHeader;
  data: boolean;
}

export interface IRosTypeUrinterfacesControlCycle {
  header: IRosTypeStdMsgsHeader;
  data: number;
}

export interface IRosTypeUrinterfacesCurrent {
  header: IRosTypeStdMsgsHeader;
  data: number;
}

export interface IRosTypeUrinterfacesDigital {
  pin: number;
  state: boolean;
}

export interface IRosTypeUrinterfacesDigitalIo {
  digital_inputs: IRosTypeUrinterfacesDigital[];
  digital_outputs: IRosTypeUrinterfacesDigital[];
}

export interface IRosTypeUrinterfacesDigitalIoStateStamped {
  header: IRosTypeStdMsgsHeader;
  configurable_io: IRosTypeUrinterfacesDigitalIo;
  standard_io: IRosTypeUrinterfacesDigitalIo;
}

export interface IRosTypeUrinterfacesDigitalStamped {
  header: IRosTypeStdMsgsHeader;
  data: IRosTypeUrinterfacesDigital;
}

export interface IRosTypeUrinterfacesDoubleMultiArrayStamped {
  header: IRosTypeStdMsgsHeader;
  data: number[];
}

export interface IRosTypeUrinterfacesFloat32Stamped {
  header: IRosTypeStdMsgsHeader;
  data: number;
}

export interface IRosTypeUrinterfacesFloat64Stamped {
  header: IRosTypeStdMsgsHeader;
  data: number;
}

export interface IRosTypeUrinterfacesJointMode {
  header: IRosTypeStdMsgsHeader;
  joint_modes: number[];
  tool_mode: number;
}

export enum IRosTypeUrinterfacesJointModeConst {
...
export interface IRosTypeUrinterfacesJointTemperature {
  header: IRosTypeStdMsgsHeader;
  data: number[];
}

export interface IRosTypeUrinterfacesJointVoltage {
  header: IRosTypeStdMsgsHeader;
  data: number[];
}

export interface IRosTypeUrinterfacesJsonStringType {
  json_string: IRosTypeStdMsgsString;
}

export interface IRosTypeUrinterfacesRobotMode {
  header: IRosTypeStdMsgsHeader;
  data: number;
}

export enum IRosTypeUrinterfacesRobotModeConst {
  DISCONNECTED = 0,
  CONFIRM_SAFETY = 1,
  BOOTING = 2,
  POWER_OFF = 3,
...
export interface IRosTypeUrinterfacesRuntimeState {
  header: IRosTypeStdMsgsHeader;
  data: number;
}

export enum IRosTypeUrinterfacesRuntimeStateConst {
  PROGRAM_STATE_UNDEFINED = -1,
  ...
  PROGRAM_STATE_RETRACTING = 6,
}

export interface IRosTypeUrinterfacesSafetyStatus {
  header: IRosTypeStdMsgsHeader;
  data: number;
}

export enum IRosTypeUrinterfacesSafetyStatusConst {
  NORMAL = 1,
  REDUCED = 2,
  PROTECTIVE_STOP = 3,
  RECOVERY = 4,
...
export interface IRosTypeUrinterfacesSetAnalogOutput {
  request: IRosTypeUrinterfacesSetAnalogOutputRequest;
  response: IRosTypeUrinterfacesSetAnalogOutputResponse;
}

export interface IRosTypeUrinterfacesSetAnalogOutputRequest {
  data: IRosTypeUrinterfacesAnalog[];
}

export interface IRosTypeUrinterfacesSetAnalogOutputResponse {
  success: boolean;
}

export interface IRosTypeUrinterfacesSetDigitalOutput {
  request: IRosTypeUrinterfacesSetDigitalOutputRequest;
  response: IRosTypeUrinterfacesSetDigitalOutputResponse;
}

export interface IRosTypeUrinterfacesSetDigitalOutputRequest {
  data: IRosTypeUrinterfacesDigital[];
}

export interface IRosTypeUrinterfacesSetDigitalOutputResponse {
  success: boolean;
}

export interface IRosTypeUrinterfacesSetSpeedFraction {
  request: IRosTypeUrinterfacesSetSpeedFractionRequest;
  response: IRosTypeUrinterfacesSetSpeedFractionResponse;
}

export interface IRosTypeUrinterfacesSetSpeedFractionRequest {
  value: number;
}

export interface IRosTypeUrinterfacesSetSpeedFractionResponse {
  success: boolean;
}

export interface IRosTypeUrinterfacesSetUrProgramState {
  request: IRosTypeUrinterfacesSetUrProgramStateRequest;
  response: IRosTypeUrinterfacesSetUrProgramStateResponse;
}

export interface IRosTypeUrinterfacesSetUrProgramStateRequest {
  program_name: string;
  requested: IRosTypeUrinterfacesUrProgramStateEnum;
}

export interface IRosTypeUrinterfacesSetUrProgramStateResponse {
  success: boolean;
}

export interface IRosTypeUrinterfacesSharedVariablesEditResponse {
  success: boolean;
  result_message: IRosTypeStdMsgsString;
}

export interface IRosTypeUrinterfacesSharedVariablesEditor {
  request: IRosTypeUrinterfacesSharedVariablesEditorRequest;
  response: IRosTypeUrinterfacesSharedVariablesEditorResponse;
}

export interface IRosTypeUrinterfacesSharedVariablesEditorRequest {
  request: IRosTypeUrinterfacesJsonStringType;
}

export interface IRosTypeUrinterfacesSharedVariablesEditorResponse {
  response: IRosTypeUrinterfacesSharedVariablesEditResponse;
}

export interface IRosTypeUrinterfacesSpeedSliderFraction {
  header: IRosTypeStdMsgsHeader;
  data: number;
}

export interface IRosTypeUrinterfacesTcpState {
  header: IRosTypeStdMsgsHeader;
  pose: IRosTypeGeometryMsgsPose;
  speed: IRosTypeGeometryMsgsTwist;
}

export interface IRosTypeUrinterfacesToolOutputMode {
  header: IRosTypeStdMsgsHeader;
  output_mode: number;
  output_pin_mode: number[];
}

export enum IRosTypeUrinterfacesToolOutputModeConst {
  TOOL_OUTPUT = 0,
  TOOL_POWER = 1,
  TOOL_SAFE = 2,
  OUTPUT_MODE_DISABLED = 0,
  OUTPUT_MODE_SINKING = 1,
  OUTPUT_MODE_SOURCING = 2,
  OUTPUT_MODE_PUSH_PULL = 3,
}

export interface IRosTypeUrinterfacesUrProgramActualState {
  header: IRosTypeStdMsgsHeader;
  program_name: IRosTypeStdMsgsString;
  actual: IRosTypeUrinterfacesUrProgramStateEnum;
}

export interface IRosTypeUrinterfacesUrProgramCompiler {
  request: IRosTypeUrinterfacesUrProgramCompilerRequest;
  response: IRosTypeUrinterfacesUrProgramCompilerResponse;
}

export interface IRosTypeUrinterfacesUrProgramCompilerRequest {
  program_source_code: string;
}

export interface IRosTypeUrinterfacesUrProgramCompilerResponse {
  has_error: boolean;
  data: IRosTypeStdMsgsString;
}
...
export interface IRosTypeUrinterfacesUrProgramError {
  header: IRosTypeStdMsgsHeader;
  program_name: IRosTypeStdMsgsString;
  error_message: IRosTypeStdMsgsString;
}

export interface IRosTypeUrinterfacesUrProgramStateEnum {
  program_state: number;
}

export enum IRosTypeUrinterfacesUrProgramStateEnumConst {
  PROGRAM_STATE_UNDEFINED = -1,
  PROGRAM_STATE_STOPPING = 0,
  PROGRAM_STATE_STOPPED = 1,
  PROGRAM_STATE_RUNNING = 2,
...
export interface IRosTypeUrinterfacesUrThreadLabel {
  header: IRosTypeStdMsgsHeader;
  program_name: IRosTypeStdMsgsString;
  thread_id: number;
  label_string: IRosTypeStdMsgsString;
  thread_string: IRosTypeStdMsgsString;
}

export interface IRosTypeUrinterfacesVariableUpdate {
  header: IRosTypeStdMsgsHeader;
  data: IRosTypeUrinterfacesJsonStringType;
}

export interface IRosTypeUrinterfacesVariablesViewer {
  response: IRosTypeUrinterfacesVariablesViewerResponse;
}

export interface IRosTypeUrinterfacesVariablesViewerResponse {
  response: IRosTypeUrinterfacesVariableUpdate;
}

export interface IRosTypeUrinterfacesVoltageCurrentStamped {
  header: IRosTypeStdMsgsHeader;
  voltage: number;
  current: number;
}

export interface IRosTypeUrinterfacesWorldModelNames {
  header: IRosTypeStdMsgsHeader;
  data: IRosTypeStdMsgsString[];
}