...
import { CommunicationChannel, MessageInvokerService, UREventTarget } from '../services';
 ...
 */
export declare class Ros2EventService extends MessageInvokerService implements Ros2ServiceApi {
     ...
     */
    subscribe<T>(connectionId: string, messageType: string, topic: string, qosProfile?: QoSProfile): Observable<T>;
    /**
     ...
     */
    callService<T>(connectionId: string, serviceType: string, serviceName: string, argumentValues: unknown, qosProfile?: QoSProfile, timeout?: number): Observable<T>;
}
