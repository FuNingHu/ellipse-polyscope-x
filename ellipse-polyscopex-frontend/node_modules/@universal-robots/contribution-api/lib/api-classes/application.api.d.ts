import { ApplicationNodeService, ApplicationVariablesService, CommunicationChannel, FramesService, MountingService, ProgramExecutionService, RobotMoveService, ToolService, UREventTarget } from '../services';
import { CommonBehaviorAPI, CommonPresenterAPI } from './common.api';
/**
 * Provides access to Application related API features in ApplicationBehaviors
 */
export declare class ApplicationBehaviorAPI extends CommonBehaviorAPI {
 ...
 */
export declare class ApplicationPresenterAPI extends CommonPresenterAPI {
