import { CommunicationChannel, RobotMoveService, UREventTarget } from '../services';
import { CommonPresenterAPI } from './common.api';
/**
 * WebComponentDialogAPI
 */
export declare class WebComponentDialogAPI extends CommonPresenterAPI {
