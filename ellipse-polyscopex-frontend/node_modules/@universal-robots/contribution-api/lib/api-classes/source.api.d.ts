import { CommunicationChannel, SignalService, SourceNodeService, UREventTarget } from '../services';
 ...
 */
export declare class SourceBehaviorAPI extends CommonBehaviorAPI {
 ...
 */
export declare class SourcePresenterAPI extends CommonPresenterAPI {
    sourceID: string;
