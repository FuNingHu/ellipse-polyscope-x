import { Ros2Client } from '../ros2/ros2-client';
import { LogMessageService, LogPerformanceService, DialogService, SafetyService, SymbolService, SourceService, SnackbarService, ProgramTreeService, SettingsService, UREventTarget, ProgramService, SystemService, CommunicationChannel, ExpressionEditorService } from '../services';
import { ApplicationService } from '../services/application/application.service';
import { RobotInfoService } from '../services/robot/robot-info.service';
import { RobotPositionService } from '../services/robot/robot-position.service';
/**
 * Provides access to common related API features in both BehaviorWorkers
 * and Presenters
 */
export declare abstract class CommonBehaviorAPI {
 ...
 */
export declare abstract class CommonPresenterAPI extends CommonBehaviorAPI {
