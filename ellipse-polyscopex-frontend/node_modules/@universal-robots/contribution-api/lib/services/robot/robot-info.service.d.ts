...
export declare const ROBOT_INFO_SERVICE_MESSAGE_TYPE_BASE = "ur.web.message.RobotInfoService.";
/**
 * Provides access to information on the robot
 */
export declare class RobotInfoService extends MessageInvokerService {
