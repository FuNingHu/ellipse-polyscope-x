...
export declare const LOG_PERFORMANCE_SERVICE_MESSAGE_TYPE_BASE = "ur.web.message.LogPerformanceService.";
/**
 * Service for sending log performance metrics
 */
export declare class LogPerformanceService extends MessageInvokerService {
