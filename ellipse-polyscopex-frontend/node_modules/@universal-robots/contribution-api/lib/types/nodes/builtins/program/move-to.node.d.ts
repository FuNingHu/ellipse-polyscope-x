import { NodeType, ProgramNode, URVariable, Waypoint } from '../..';
import { TabInputModel } from '../../../common';
import { Acceleration, Angle, AngularAcceleration, AngularSpeed, Length, Speed, Value } from '../../../values';
...
export interface MoveToNode extends ProgramNode {
